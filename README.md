...
A production-style multi-agent AI knowledge assistant that retrieves relevant information from documents using semantic search and generates accurate answers using large language models. The system is containerized, observable, and deployable locally via Docker or in the cloud using AWS + Terraform.
